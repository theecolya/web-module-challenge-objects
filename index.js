...
console.log(createMenuItem('scramble bowl',5,'Breakfast'))
console.log(createMenuItem('acai bowl',5,'Brunch'))
...
const burger = {
  ...
  price: 18,
  category: 'Lunch',
  discount: function discount(discount) {
